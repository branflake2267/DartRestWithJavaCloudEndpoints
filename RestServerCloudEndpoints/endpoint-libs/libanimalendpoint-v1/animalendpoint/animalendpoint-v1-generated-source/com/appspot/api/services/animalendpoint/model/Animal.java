 ...
 * @author Google, Inc.
 */
public final class Animal extends GenericJson {
   ...
   * example, a request that returns a single {@link Animal} would include the response headers,
   * while a request which returns an array of {@link Animal}, would have a non-null response header
