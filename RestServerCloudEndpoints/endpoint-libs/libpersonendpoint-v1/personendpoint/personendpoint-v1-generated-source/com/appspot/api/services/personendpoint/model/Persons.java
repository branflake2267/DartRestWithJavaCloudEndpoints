...
package com.appspot.api.services.personendpoint.model;
 ...
 * @author Google, Inc.
 */
public final class Persons extends GenericJson {
   ...
   */
  public Persons setItems(java.util.List<Person> items) {
    this.items = items;
    return this;
  }
   ...
   * example, a request that returns a single {@link Persons} would include the response headers,
   * while a request which returns an array of {@link Persons}, would have a non-null response
